          ...
          <div class="payment-form">
            ...
            <div class="bg-white rounded-lg shadow-md p-6">
              ...
              <div v-else class="text-center py-8">
                <el-icon class="text-4xl text-gray-400 mb-4"><CreditCard /></el-icon>
                <p class="text-gray-600">该支付方式暂未开放</p>
              </div>
              ...
              <div class="space-y-4">
                ...
                >
                  {{ processing ? '处理中...' : `支付 $${selectedPlan ? (selectedPlan.price / 100).toFixed(2) : '0.00'}` }}
                </el-button>
