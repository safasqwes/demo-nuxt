      ...
      <div v-else>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 mb-8">
          <div 
            ...
            :key="novel.id"
            class="novel-card bg-white rounded-lg shadow-md overflow-hidden hover:shadow-lg transition-shadow cursor-pointer"
            ...
            <div class="p-4">
              ...
              <div class="flex gap-2">
                <el-button 
                  ...
                  size="small" 
                  class="flex-1"
                  @click.stop="startReading(novel.id)"
                >
                  开始阅读
                </el-button>
                <el-button 
                  size="small"
                  @click.stop="toggleBookmark(novel.id)"
                >
