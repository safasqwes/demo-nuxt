  ...
  <div v-if="novel" class="novel-detail">
    ...
    <div class="content-section">
      <div class="section-header">
        ...
        <button @click="showAllChapters = !showAllChapters" class="toggle-btn">
          {{ showAllChapters ? 'Show Less' : 'View All Chapters' }}
        </button>
      </div>
      
      <div v-if="novelStore.loading" class="loading">Loading chapters...</div>
      <div v-else class="chapters-list">
        ...
        >
          ...
          <div class="chapter-meta">
            ...
            <span class="chapter-words">{{ chapter.wordCount }} words</span>
          </div>
        </NuxtLink>
      </div>
    </div>
